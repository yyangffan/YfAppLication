package com.superc.yf_lib.views.date_time;
...
public class CustomDatePicker {
    ...
    /*使用的时候只需要将下面的copy到项目中--注意TextView需要设定好一个默认时间*/
    /*
    ...
    public void showDateDialog(final TextView mtv) {
        ...
        customDatePickerSt = new CustomDatePicker(this, new CustomDatePicker.ResultHandler() {
            ...
            public void handle(String time) { // 回调接口，获得选中的时间
                mtv.setText(time);
                choseTime = DateUtil.data(time);
                Log.e("开始", "开始时间的时间戳:" + DateUtil.data(time));
            }
    ...
    public void initDatePick() {
        ...
        mMainTvDatepick.setText(now_time);
    }*/
