package com.superc.yf_lib.utils.titlebar;
...
public class TitleUtils {
    ...
    public static void setStatusTextColor(boolean useDart, Activity activity) {
        if (RomUtil.isFlyme()) {
            ...
            activity.getWindow().getDecorView().findViewById(android.R.id.content).setPadding(0, 0, 0, TitleUtils.navigationHeight);
        }
    }
}
